...
class Settings:
    ...
    # 网站描述
    DESCRIPTION = config('DESCRIPTION', cast=str, default="BoFileCabinet，口令文件快传")
    # 网站关键词
    KEYWORDS = config('KEYWORDS', cast=str, default="BoFileCabinet，口令文件快传")
    ...
    async def updates(self, options) -> None:
        with open('data/.env', 'w', encoding='gbk') as f:
